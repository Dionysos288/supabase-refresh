...
import type { NavIconProps } from '@/data/types'
...
export const skillBasedSolutions = {
  ...
  solutions: [
    ...
    },
    {
      ...
      icon: ({ className = 'h-4 w-4' }: NavIconProps) => (
        <svg
          width="26"
          height="25"
          viewBox="0 0 26 25"
  ...
  solutions: [
    {
      ...
      icon: ({ className }: NavIconProps) => (
        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 600 600" className={className}>
          <path
            fill="#FF9100"
