                  ...
                  >
                    ...
                    <div className="flex flex-col justify-center">
                      <div className="flex items-center gap-1">
                        ...
                        <ChevronRight
                          strokeWidth={2}
                          className="w-3 h-3 text-foreground transition-[transform,opacity] will-change-transform -translate-x-1 opacity-0 group-hover/menu-item:translate-x-0 group-hover/menu-item:opacity-100"
                        />
                      </div>
        ...
        <div className="col-span-3 flex flex-row gap-8 xl:w-auto">
          <div>
            ...
            <ul className="flex flex-row gap-2">
              {CustomersData.slice(0, 1).map((customer) => (
